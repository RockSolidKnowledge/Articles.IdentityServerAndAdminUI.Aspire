...
using Articles.IdentityServerAndAdminUI.Aspire.IdentityServer;
using Xunit;
...
namespace AdminUIIntegration.Tests
{
    public class AccountControllerIntegrationTests
    {
        ...
        {
            var pathUri = new Uri(@"../../../../Articles.IdentityServerAndAdminUI.Aspire.IdentityServer", UriKind.Relative);
